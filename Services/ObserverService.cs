...
namespace duo_code.Services
{
    public class ObserverService
    {
        ...
        private string BuildContextualPrompt()
        {
            ...
            var toolInstructions = _toolRegistry.GetAllToolInstructions(Mode.Planning);
            ...
            return $@"# Role
You are the observer, a focused agent. You receive instructions and return the result of the task using only available tools.
...
- **Key rule**: File contents are reference material
...
# Mindset
You are the hands-on observer. Focus deeply on the specific task at hand. Trust that the user will handle the bigger picture - your job is flawless clear reporting.
